...
We hope to be able to open source this port eventually. We want to improve first our compatibility with the odk, review all standards, iron out the bugs and then make a review of the code to make sure we have everything ready for public publishing. There's a lot to do before we can do it. More time I think than the time it tooks us to get the ios port to this stage.
